...
def train(problem, policy, min_cost, *,
    ...
    # ----------------------------------------
    pi = policy
    oldpi = create_policy("oldpi", problem) # Network for old policy
    ...
    # ----------------------------------------
    seg_gen = traj_segment_generator(pi, problem, timesteps_per_actorbatch, stochastic=True)
