...
class DataLogger:
    def __init__(self, col_names, filepath, data_dir, auto_save_every=4):
        ...
        self.internal_dict = {col: [np.nan] for col in col_names}
    ...
    def save_to_npy(self, file_prefix, data):
        if len(data) == 0:
            print('Received a 0-length list, returning!', flush=True)
            return
